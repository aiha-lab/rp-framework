...
```bash
cd /root/workspace/rp_training/dataset && python gen_alpaca_dataset.py
```
...
cd /root/workspace/rp_training && bash scripts/llama2-alpaca-gpt-sft-r128.sh  # Takes about 2 hours on four A6000-48GB GPUs

# W4A16 Model + Alpaca-GPT4 Fine-tuning (QLoRA-like)
cd /root/workspace/rp_training && bash scripts/llama2-w4a16-alpaca-gpt-sft-r128.sh
```
...
cd /root/workspace/rp_inference && bash scripts/run.sh 0 /raid/LLM/llama2-7b

# Alpaca-GPT4 Fine-tuned
cd /root/workspace/rp_inference && bash scripts/run.sh 0 /raid/LLM/llama2-7b-alpaca-gpt4-nomask-lora128

# W4A16 (MXFP4)
cd /root/workspace/rp_inference && bash scripts/linear_w4a16.sh 0 /raid/LLM/llama2-7b

# W4A16 (MXFP4) + Alpaca-GPT4 Fine-tuned
cd /root/workspace/rp_inference && bash scripts/linear_w4a16.sh 0 /raid/LLM/llama2-7b-mxfp4-w4a16-alpaca-gpt4-nomask-lora128
```
